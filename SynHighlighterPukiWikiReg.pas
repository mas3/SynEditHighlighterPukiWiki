...
The Original Code is SynHighlighterPukiWikiReg.pas, released 2025-04-26.
...
-------------------------------------------------------------------------------}
unit SynHighlighterPukiWikiReg;

interface

uses
  System.Classes, SynHighlighterPukiWiki;
...
procedure Register;
begin
  RegisterComponents('SynEdit Highlighters', [TSynPukiWikiSyn]);
end;
